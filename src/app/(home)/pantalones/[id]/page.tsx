                    ...
                    <div className='w-auto m-auto 2xl:w-3/4 '>
                        <div className='flex items-center gap-3'>
                            <div className='hidden md:flex flex-col gap-4'>
                                <Image width={95} height={120} src={pantalonesId.image} alt='img-remeras' style={{ objectFit: 'cover' }} className='cursor-pointer' />
                                <Image width={95} height={120} src={pantalonesId.image2} alt='img-remeras' style={{ objectFit: 'cover' }} className='cursor-pointer' />
                                <Image width={95} height={120} src={pantalonesId.image3} alt='img-remeras' style={{ objectFit: 'cover' }} className='cursor-pointer' />
                            </div>
                            <div className='m-auto'>
                                <Image width={450} height={550} src={pantalonesId.image} alt='img-remeras' style={{ objectFit: 'cover' }} className='cursor-pointer' />
                            </div>
                        </div>
                    </div>
