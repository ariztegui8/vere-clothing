    ...
    return (
        <div className='relative w-full h-[350px]'>
            ...
            <div className='absolute w-full flex flex-col items-center justify-center gap-4 md:gap-8 h-full px-2'>
                ...
                <button className='text-white text-lg md:text-2xl border border-white py-1 md:py-2 px-6 md:px-10 rounded-xl md:rounded-md bg-[#C4C4C4] duration-200 opacity-80 hover:opacity-100 '>Ver más</button>
            </div>
        </div>
